...
public class Interfaz {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("     Escriba 5 para consultar las condiciones legals");
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("La opción que ha elegido es consultar las condiciones legales");
				cajero.mostrarCondicionesLegals();
				break;
			default:
