...
public class DeadlockKitchen {
	...
	public static void main(String[] args) {
		...
		//El programa correra para siempre ya que el hilo 1 necesita un objeto para terminar que esta utilizando el hilo 2 y viceversa
