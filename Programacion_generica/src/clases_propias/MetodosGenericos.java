...
class MisMatrices{
	...
	public static <T> String getElementos(T[]a) { //este método recibe un elemento genérico y devuelve un String
		return "El array tiene " + a.length + " elementos.";	
	}
	
	public static <T extends Comparable> T getMenor(T[]a) { //este método recibe un elemento genérico y devuelve el mismo tipo, para usar el método compareTo el elemento debe heredar de Comparable
