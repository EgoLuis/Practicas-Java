...
public class AbstractAided extends AbstractStudent {
	...
	public String result(String allMarks) {
		...
		String[] nccMarks = SetList[1].split(",");
		String[] sportsMarks = SetList[2].split(",");
		...
		firstM = Double.parseDouble(nccMarks[1]);
		secondM = Double.parseDouble(nccMarks[2]);
		thirdM = Double.parseDouble(nccMarks[0]);
		firstM = changeGrade(firstM);
